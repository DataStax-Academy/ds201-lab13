      ...
      <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
        <div class="feature col div-choice">
          ...
          <div class="scenario-objectives">In this hands-on lab, you learned how to:</div>
            <ul>
              <li><span class="scenario-objective">Write data with a consistency level of <code>ANY</code></li>
              <li><span class="scenario-objective"> Observe how hinted handoff helps keep offline replicas consistent</span></li>
            </ul>
        </div>
      </div>
    </div>
